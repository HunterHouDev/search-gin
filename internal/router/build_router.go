...
func BuildAPIRouter(sigChan chan os.Signal) *gin.Engine {
	...
	router.POST("/api/tranferToMp4", handler.PostTransferToMp4)
	router.POST("/api/mergeFiles", handler.PostMerge)
	router.POST("/api/cutMovie", handler.PostCutMovie)
	router.POST("/api/setMovieType/:id/:movieType", handler.SetMovieType)
	router.POST("/api/info", handler.PostInfo)
	router.POST("/api/renameFile", handler.PostRename)
	router.POST("/api/addFileTag", handler.PostAddTag)
	router.POST("/api/clearFileTag", handler.PostClearTag)
	router.GET("/api/dir/:id/:sort", handler.GetDirInfo)
	router.POST("/api/delete", handler.PostDelete)

	router.POST("/api/openFolder", handler.PostOpenFolder)
	...
	router.POST("/api/cutImage", handler.PostCutImage)
	...
	router.POST("/api/torrent/openFolder", handler.PostOpenTorrentFolder)
